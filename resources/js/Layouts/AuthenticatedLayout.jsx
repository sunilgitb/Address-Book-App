...
const subMenu = [
    {id: 1, name: 'Address', href: '/dashboard/be/address/list', initial: 'B', routeName: 'dashboard.be.books.list'},
                                ...
                                <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4">
                                    ...
                                    <nav className="flex flex-1 flex-col">
                                        <ul role="list" className="flex flex-1 flex-col gap-y-7">
                                                    ...
                                                    {mainMenu.map((item) => (
                                                        <li key={uuidv1() + '-' +item.id}>
                                                            ...
                                                            >
                                                                <item.icon
                                                                    className={classNames(
                                                                        route().current(item.routeName) ? 'text-indigo-600' : 'text-gray-400 group-hover:text-indigo-600',
                                                                        'h-6 w-6 shrink-0'
                                                                    )}
                                                                    aria-hidden="true"
                                                                />
                                            ...
                                            <li>
                                                <div
                                                    className="text-xs font-semibold leading-6 text-gray-400">Features
                                                </div>
                                                <ul role="list" className="-mx-2 mt-2 space-y-1">
                                                    {subMenu.map((team) => (
                                                        <li key={uuidv1() + '-' +team.id}>
                                                            <Link
                                                                href={team.href}
                                                                className={classNames(
                                                                    route().current(team.routeName)
                                                                        ? 'bg-gray-50 text-indigo-600'
                                                                        : 'text-gray-700 hover:text-indigo-600 hover:bg-gray-50',
                                                                    'group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold'
                                                                )}
                ...
                <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 pb-4">
                    ...
                    <nav className="flex flex-1 flex-col">
                        <ul role="list" className="flex flex-1 flex-col gap-y-7">
                            ...
                            <li>
                                <div className="text-xs font-semibold leading-6 text-gray-400">Front-End</div>
                                <ul role="list" className="-mx-2 mt-2 space-y-1">
                                    {subMenu.map((team) => (
                                        <li key={uuidv1() + '-' +team.id}>
                                            <Link
                                    ...
                                    <Menu.Items
                                        ...
                                        <Menu.Item >
                                            <Link
                                                ...
                                                className={classNames(
                                                    route().current('dashboard.profile.edit') ? 'bg-gray-50' : '',
